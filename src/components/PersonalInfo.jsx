        ...
        <Stack >
            <CardBody w='380px' mr='35px'>
                ...
                <FormControl>
                    ...
                    <FormLabel fontSize='12px' color={'blue.400'} mb='4px'>Phone Number</FormLabel>
                    <Input mb={5} placeholder='e.g. +1 234 567 890' id='phone' />

                    <Button colorScheme="button" color='white' float='right' fontSize='12px' onClick={() => setProgress('plan')}>Next Step</Button>
                </FormControl>
